...
jl.seval("using MySRCore")
MySRCore = jl.MySRCore
SymbolicRegression = MySRCore.SymbolicRegression

# Expose `D` operator:
jl.seval("using MySRCore.SymbolicRegression: D")

# Expose other operators:
jl.seval("using MySRCore.SymbolicRegression: less, greater_equal, less_equal")
